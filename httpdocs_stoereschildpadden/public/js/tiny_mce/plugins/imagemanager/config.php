<?php
	...
	$mcImageManagerConfig['filesystem.path'] = VIT_UPLOAD_PATH; // absolute or relative from this script path, optional.
	$mcImageManagerConfig['filesystem.rootpath'] = VIT_UPLOAD_PATH; // absolute or relative from this script path, required.
