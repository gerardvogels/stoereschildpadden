<?php
	...
	define('VIT_UPLOAD_PATH',dirname(__FILE__) .'/../../../../upload');
	...
	$mcFileManagerConfig['filesystem.path'] = VIT_UPLOADPATH; // absolute or relative from this script path.
	$mcFileManagerConfig['filesystem.rootpath'] = VIT_UPLOAD_PATH; // absolute or relative from this script path.
	...
	$mcFileManagerConfig['filesystem.extensions'] = "gif,jpg,htm,html,pdf,zip,txt,php,png,swf,dcr,mov,qt,ram,rm,avi,mpg,mpeg,asf,flv,pdf";
	...
	$mcFileManagerConfig['upload.extensions'] = "gif,jpg,png,pdf,zip,pdf";
