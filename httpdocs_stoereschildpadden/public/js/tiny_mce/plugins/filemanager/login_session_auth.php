<?php
	...
	// VIT 20110519 onderstaande code omzeilt de login van imagemanager
	// @todo: Onderzoeken of dit mogelijk veiligheidsrisico's oplevert.
	
	session_start();
	$_SESSION['isLoggedIn'] = true;
	$_SESSION['user'] = 'mciUser';
	exit;
	
	// einde van de omleiding
